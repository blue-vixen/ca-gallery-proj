...
function getAllPossibleCoordsRook(pieceCoord) {
    ...
    for (var idx = pieceCoord.j - 1; idx >= 0; idx--) { // checking cols.
        var nextCoord = { i: pieceCoord.i, j: idx }
        // console.log(nextCoord, 'to the left');
        if (!isEmptyCell(nextCoord)) break;
        res.push(nextCoord);
    }
...
function getAllPossibleCoordsBishop(pieceCoord) {
    ...
    // console.log(res)
    i = pieceCoord.i - 1;
    //diagonal upward & to the left
    for (var idx = pieceCoord.j - 1; i >= 0 && idx >= 0; idx--) { //idx = 6
        var coord = { i: i--, j: idx };
        // console.log('coord', coord);
        if (!isEmptyCell(coord)) break;
        res.push(coord);
    ...
    for (var idx = pieceCoord.j + 1; i < gBoard.length && idx < 8; idx++) {
        var coord = { i: i++, j: idx };
        console.log('coord left and down', coord);
        // if (!isEmptyCell(coord)) break;
        res.push(coord);
    }
